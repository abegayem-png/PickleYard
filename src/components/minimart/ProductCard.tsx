    ...
    <Card className={`overflow-hidden ${soldOut ? 'opacity-50' : ''}`}>
      ...
      <div className="p-3">
        ...
        <div className="mt-2 flex items-center justify-between">
          ...
          {!soldOut && <p className="text-xs font-semibold text-cream-dim">Available</p>}
        </div>
        ...
        {soldOut ? (
          ...
          <div className="mt-3 flex items-center justify-between rounded-xl bg-court-900/60 p-1">
            ...
            <button
              ...
              className="grid h-8 w-8 shrink-0 place-items-center rounded-lg bg-lime-500 text-lg font-bold text-court-950"
