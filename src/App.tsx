...
import AdminMiniMartInventoryHistory from './pages/admin/AdminMiniMartInventoryHistory'
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/admin" element={<AdminLayout />}>
              ...
              <Route path="mini-mart/inventory" element={<AdminMiniMartInventoryHistory />} />
